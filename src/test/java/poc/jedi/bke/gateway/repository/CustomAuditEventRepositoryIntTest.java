package poc.jedi.bke.gateway.repository;

import poc.jedi.bke.gateway.PocJediBkeGateway2App;
import poc.jedi.bke.gateway.config.Constants;
import poc.jedi.bke.gateway.config.audit.AuditEventConverter;
import poc.jedi.bke.gateway.domain.PersistentAuditEvent;
...
import static poc.jedi.bke.gateway.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
