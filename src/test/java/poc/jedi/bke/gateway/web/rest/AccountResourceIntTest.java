package poc.jedi.bke.gateway.web.rest;

import poc.jedi.bke.gateway.config.Constants;
import poc.jedi.bke.gateway.PocJediBkeGateway2App;
import poc.jedi.bke.gateway.domain.Authority;
import poc.jedi.bke.gateway.domain.User;
import poc.jedi.bke.gateway.repository.AuthorityRepository;
import poc.jedi.bke.gateway.repository.UserRepository;
import poc.jedi.bke.gateway.security.AuthoritiesConstants;
import poc.jedi.bke.gateway.service.MailService;
import poc.jedi.bke.gateway.service.dto.UserDTO;
import poc.jedi.bke.gateway.service.dto.PasswordChangeDTO;
import poc.jedi.bke.gateway.web.rest.errors.ExceptionTranslator;
import poc.jedi.bke.gateway.web.rest.vm.KeyAndPasswordVM;
import poc.jedi.bke.gateway.web.rest.vm.ManagedUserVM;
import poc.jedi.bke.gateway.service.UserService;
...
@SpringBootTest(classes = PocJediBkeGateway2App.class)
